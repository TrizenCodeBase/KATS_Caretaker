                ...
                <Picker
                  selectedValue={attendanceData.type}
                    ...
                    >
                      ...
                      <Picker.Item label="Home Pickup" value="Home Pickup" color="#FFFFFF" style={{color: '#FFFFFF'}}/>
                      <Picker.Item label="Home Drop" value="Home Drop" color="#FFFFFF" style={{color: '#FFFFFF'}}/>
                      <Picker.Item label="Institute Pickup" value="Institute Pickup" color="#FFFFFF" style={{color: '#FFFFFF'}}/>
                      <Picker.Item label="Institute Drop" value="Institute Drop" color="#FFFFFF" style={{color: '#FFFFFF'}}/>
                </Picker>
              </View>
                </View>
              </View>
